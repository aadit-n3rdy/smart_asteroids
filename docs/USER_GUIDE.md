...
### Movement
Left Mouse Button Holding accelerates the ship toward the mouse pointer

### Combat
Right Mouse Button Holding fires bullets in the direction the ship is facing
...
ESC to open the pause menu during gameplay

### Navigation
Mouse Cursor Navigate the pause menu
Click Left Mouse Button 
RESUME to Resume gameplay
QUIT to Exit the game
EXIT TO MENU to Return to the main menu

---

## Game Over Screen Controls
Mouse Cursor to Navigate the game over menu
Click Left Mouse Button 
...
reflecting its experimental and educational goal
These systems are not currently exposed as a selectable gameplay mode
